...
<?php
    header("refresh:5;url=stand.php"); // refresh halaman data user
}
?>
...
<?php
    header("refresh:5;url=stand.php");
}
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="stand.php">Stand</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $brgs = mysqli_query($conn, "SELECT * from stand WHERE STATUS like 'Verified' order by ID_STAND ASC");
                                            $no = 1;
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="stand.php?op=delete&id=<?php echo $id ?>" onclick="return confirm('Hapus data stand ?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                    </td>
                                                </tr>
