                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href="kelola_admin.php"><span>Kelola Admin</span></a></li>
                            <li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $brgs = mysqli_query($conn, "SELECT * from admin order by ID_ADMIN ASC");
                                            $no = 1;
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <td><?php echo $no++ ?></td>
                                                    <td><?php echo $p['ID_ADMIN'] ?></td>
                                                    <td><?php echo $p['NAMA_ADMIN'] ?></td>
                                                    <td><?php echo $p['EMAIL_ADMIN'] ?></td>
                                                    <td><?php echo $p['USERNAME_ADMIN'] ?></td>
                                                    <td><?php echo $p['PASSWORD_ADMIN'] ?></td>
                                                    <td>
                                                        <a href="kelola_admin.php?op=delete&id=<?php echo $id ?>" onclick="return confirm('Hapus data admin ?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                    </td>
