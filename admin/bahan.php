...
<head>
    ...
    <title>Kelola Bahan - Stand.in</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h2>Daftar Bahan</h2>
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2">Tambah Bahan</button>
                                </div>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        ...
                                                        $result1 = mysqli_query($conn, "SELECT Count(ID_STAND) AS count FROM stand p, bahan_stand k where p.id_bahan=k.id_bahan and k.id_bahan='$id' order by id_stand ASC");
                                                    ...
                                                    <td>
                                                        <a href="bahan.php?op=delete&id=<?php echo $id ?>" onclick="return confirm('Hapus bahan stand ?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                    </td>
                                                </tr>
