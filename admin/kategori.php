...
if ($op == 'delete') {
    $id         = $_GET['id'];
    $sqldelete  = "delete from jenis_stand where id_jenis = '$id'";
...
<head>
    ...
    <title>Kelola Kategori - Stand.in</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $brgs = mysqli_query($conn, "SELECT * from jenis_stand order by ID_JENIS ASC");
                                            $no = 1;
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        ...
                                                        $result1 = mysqli_query($conn, "SELECT Count(ID_STAND) AS count FROM stand p, jenis_stand k where p.id_jenis=k.id_jenis and k.id_jenis='$id' order by id_stand ASC");
                                                    ...
                                                    <td>
                                                        <a href="kategori.php?op=delete&id=<?php echo $id ?>" onclick="return confirm('Hapus kategori stand ?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                    </td>
                                                </tr>
