                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active"><a href="kelola_user.php"><span>Kelola User</span></a></li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $brgs = mysqli_query($conn, "SELECT * from user order by ID_USER ASC");
                                            $no = 1;
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $p['NO_TELP_USER'] ?></td>
                                                    <td><?php echo $p['ALAMAT_USER'] ?></td>
                                                    <td>
                                                        <a href="kelola_user.php?op=delete&id=<?php echo $id ?>" onclick="return confirm('Hapus bahan stand ?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                    </td>
